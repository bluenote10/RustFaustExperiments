...
static ftbl0DspSIG0: RwLock<[F32; 65536]> = RwLock::new([0.0; 65536]);
mod ffi {
...
impl Dsp {
    ...
    pub fn class_init(sample_rate: i32) {
        ...
        let mut ftbl0DspSIG0_data = ftbl0DspSIG0.write().unwrap();
        sig0.fillDspSIG0(65536, ftbl0DspSIG0_data.as_mut());
    }
    ...
    pub fn compute(
        ...
        let ftbl0DspSIG0_data = ftbl0DspSIG0.read().unwrap();
