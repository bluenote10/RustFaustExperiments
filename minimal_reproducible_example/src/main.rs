    ...
    F: Fn() -> Box<dyn FaustDsp<T = FloatType>>,
{
    ...
    let throughputs: Vec<_> = (1 ..= num_bocks).map(|i| {
        ...
        // Compute
        let mut last_sample_checksum = 0.0f32;
        ...
        while num_samples_written < min_samples {
            ...
            // Access last sample to prevent over-optimizations
            for c in 0..num_outputs {
                unsafe {
                    last_sample_checksum += out_buffer.get_unchecked(c).get_unchecked(buffer_size - 1);
                }
            }
...
impl FaustDsp for Dsp {
    ...
    fn compute(&mut self, count: i32, inputs: &[&[Self::T]], outputs: &mut [&mut [Self::T]]) {
        ...
        for (output0, output1) in zipped_iterators {
            ...
            self.fVec0[0] = fSlow2;
            self.fRec2[0] = self.fRec2[1] + ((((fSlow2 - self.fVec0[1]) > 0.0) as i32) as F32)
                - fSlow1 * (((self.fRec2[1] > 0.0) as i32) as F32);
            let mut fTemp0: F32 = fSlow3
                * ((((self.fRec2[0] > 0.0) as i32) as F32) + 1.5258789e-05)
                * ((self.iRec1[0]) as F32);
            ...
            self.fVec11[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec12[1] + self.fRec12[2]);
            self.fRec12[0] =
                self.fVec11[((i32::wrapping_sub(self.IOTA0, iSlow27)) & 8191) as usize];
            self.fVec12[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec13[1] + self.fRec13[2]);
            self.fRec13[0] =
                self.fVec12[((i32::wrapping_sub(self.IOTA0, iSlow29)) & 8191) as usize];
            self.fVec13[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec14[1] + self.fRec14[2]);
            self.fRec14[0] =
                self.fVec13[((i32::wrapping_sub(self.IOTA0, iSlow31)) & 4095) as usize];
            ...
            self.fVec15[(self.IOTA0 & 2047) as usize] =
                fTemp0 + fSlow0 * (self.fRec16[1] + self.fRec16[2]);
            self.fRec16[0] =
                self.fVec15[((i32::wrapping_sub(self.IOTA0, iSlow35)) & 2047) as usize];
            self.fVec16[(self.IOTA0 & 511) as usize] =
                fSlow0 * (self.fRec17[1] + self.fRec17[2]) + fTemp0;
            ...
            *output0 = fSlow39
            ...
            self.fVec26[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec27[1] + self.fRec27[2]);
            self.fRec27[0] =
                self.fVec26[((i32::wrapping_sub(self.IOTA0, iSlow58)) & 8191) as usize];
            self.fVec27[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec28[1] + self.fRec28[2]);
            self.fRec28[0] =
                self.fVec27[((i32::wrapping_sub(self.IOTA0, iSlow60)) & 8191) as usize];
            self.fVec28[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec29[1] + self.fRec29[2]);
            self.fRec29[0] =
                self.fVec28[((i32::wrapping_sub(self.IOTA0, iSlow62)) & 8191) as usize];
            self.fVec29[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec30[1] + self.fRec30[2]);
            self.fRec30[0] =
                self.fVec29[((i32::wrapping_sub(self.IOTA0, iSlow64)) & 4095) as usize];
            self.fVec30[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec31[1] + self.fRec31[2]);
            self.fRec31[0] =
                self.fVec30[((i32::wrapping_sub(self.IOTA0, iSlow66)) & 4095) as usize];
            self.fVec31[(self.IOTA0 & 2047) as usize] =
                fTemp0 + fSlow0 * (self.fRec32[1] + self.fRec32[2]);
            self.fRec32[0] =
                self.fVec31[((i32::wrapping_sub(self.IOTA0, iSlow68)) & 2047) as usize];
            self.fVec32[(self.IOTA0 & 1023) as usize] =
                fTemp0 + fSlow0 * (self.fRec33[1] + self.fRec33[2]);
            self.fRec33[0] =
                self.fVec32[((i32::wrapping_sub(self.IOTA0, iSlow70)) & 1023) as usize];
            *output1 = fSlow39
