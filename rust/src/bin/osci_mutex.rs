...
static ftbl0DspSIG0: Mutex<[F32; 65536]> = Mutex::new([0.0; 65536]);
mod ffi {
...
impl Dsp {
    ...
    pub fn class_init(sample_rate: i32) {
        ...
        let mut ftbl0DspSIG0_data = ftbl0DspSIG0.lock().unwrap();
    ...
    pub fn compute(
        ...
        let ftbl0DspSIG0_data = ftbl0DspSIG0.lock().unwrap();
