...
class Dsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst4 = 1979.2034f / fConst0;
		fConst5 = (1.0f - fConst4) / (fConst4 + 1.0f);
		fConst6 = std::cos(fConst4) * (fConst5 + 1.0f);
		fConst7 = std::floor(0.174713f * fConst0 + 0.5f);
		fConst8 = fConst7 / fConst0;
		fConst9 = std::exp(-(3.4538777f * fConst8));
		fConst10 = Dsp_faustpower2_f(fConst9);
		fConst11 = 1.0f - fConst10;
		fConst12 = std::cos(37699.113f / fConst0);
		fConst13 = 1.0f - fConst12 * fConst10;
		fConst14 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst13) / Dsp_faustpower2_f(fConst11) + -1.0f));
		fConst15 = fConst13 / fConst11;
		...
		fConst29 = Dsp_faustpower2_f(fConst28);
		fConst30 = 1.0f - fConst29;
		fConst31 = 1.0f - fConst12 * fConst29;
		fConst32 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst31) / Dsp_faustpower2_f(fConst30) + -1.0f));
		fConst33 = fConst31 / fConst30;
		...
		fConst43 = Dsp_faustpower2_f(fConst42);
		fConst44 = 1.0f - fConst43;
		fConst45 = 1.0f - fConst12 * fConst43;
		fConst46 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst45) / Dsp_faustpower2_f(fConst44) + -1.0f));
		...
		fConst57 = Dsp_faustpower2_f(fConst56);
		fConst58 = 1.0f - fConst57;
		fConst59 = 1.0f - fConst12 * fConst57;
		fConst60 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst59) / Dsp_faustpower2_f(fConst58) + -1.0f));
		fConst61 = fConst59 / fConst58;
		...
		fConst71 = Dsp_faustpower2_f(fConst70);
		fConst72 = 1.0f - fConst71;
		fConst73 = 1.0f - fConst12 * fConst71;
		fConst74 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst73) / Dsp_faustpower2_f(fConst72) + -1.0f));
		fConst75 = fConst73 / fConst72;
		...
		fConst85 = Dsp_faustpower2_f(fConst84);
		fConst86 = 1.0f - fConst85;
		fConst87 = 1.0f - fConst12 * fConst85;
		fConst88 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst87) / Dsp_faustpower2_f(fConst86) + -1.0f));
		fConst89 = fConst87 / fConst86;
		...
		fConst99 = Dsp_faustpower2_f(fConst98);
		fConst100 = 1.0f - fConst99;
		fConst101 = 1.0f - fConst12 * fConst99;
		fConst102 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst101) / Dsp_faustpower2_f(fConst100) + -1.0f));
		fConst103 = fConst101 / fConst100;
		...
		fConst113 = Dsp_faustpower2_f(fConst112);
		fConst114 = 1.0f - fConst113;
		fConst115 = 1.0f - fConst12 * fConst113;
		fConst116 = std::sqrt(std::max<float>(0.0f, Dsp_faustpower2_f(fConst115) / Dsp_faustpower2_f(fConst114) + -1.0f));
		fConst117 = fConst115 / fConst114;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider0, "tooltip", "Ratio of dry and wet signal. -1 = fully wet, +1 = fully dry");
		ui_interface->addVerticalSlider("Wet/Dry Mix", &fVslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = fVec3[(IOTA0 - iConst38) & 16383] + fTemp3 - 0.6f * fRec14[1];
			...
			float fTemp7 = fVec5[(IOTA0 - iConst52) & 16383] - (fTemp3 + 0.6f * fRec18[1]);
			...
			float fTemp8 = fVec7[(IOTA0 - iConst66) & 16383] - (fTemp3 + 0.6f * fRec22[1]);
			...
			float fTemp13 = fVec12[(IOTA0 - iConst94) & 16383] + fTemp11 + 0.6f * fRec30[1];
			...
			float fTemp14 = 0.6f * fRec34[1] + fVec14[(IOTA0 - iConst108) & 32767];
			...
			float fTemp15 = 0.6f * fRec38[1] + fVec16[(IOTA0 - iConst122) & 32767];
			...
			fRec1[0] = fTemp22 - fConst5 * fRec1[2];
			float fTemp23 = fConst5 * fRec1[0];
			float fTemp24 = 0.5f * (fTemp23 + fTemp21 + fRec1[2] - fTemp1 + (fRec1[2] + fTemp23 - fTemp22));
			float fTemp25 = fTemp24 + fTemp0;
			fRec0[0] = fTemp25 - fConst2 * fRec0[2];
			float fTemp26 = fConst2 * fRec0[0];
			...
			fRec45[0] = fTemp32 - fConst5 * fRec45[2];
			float fTemp33 = fConst5 * fRec45[0];
			float fTemp34 = 0.5f * (fTemp33 + fTemp31 + fRec45[2] - fTemp30 + (fRec45[2] + fTemp33 - fTemp32));
